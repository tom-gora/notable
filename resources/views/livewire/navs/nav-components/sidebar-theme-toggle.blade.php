...
<div class="fixed left-1 top-20 z-50 flex w-16 grow justify-center md:grow-0">
    <button aria-label="Toggle theme"
        ...
        role="switch">
        <div class="{{ $theme == 'dark' ? 'bg-info translate-x-6' : 'bg-warning translate-x-1' }} text-accent-primary-content relative aspect-square w-6 transform rounded-full p-1 transition duration-300"
            id="theme-toggle">
