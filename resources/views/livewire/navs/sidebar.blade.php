...
<nav aria-expanded="{{ $sidebarState ? 'true' : 'false' }}" aria-labelledby="drawer-navigation-label"
    class="{{ $sidebarState ? '' : '-translate-x-[calc(100%-4.8rem)]' }} bg-base-200 text-text-primary fixed top-0 z-40 flex h-screen max-h-lvh w-screen flex-col-reverse overflow-y-auto px-4 py-12 transition-transform duration-300 md:max-h-none md:w-64 md:py-4"
