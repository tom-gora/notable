...
<nav id="drawer-navigation"
    class="fixed z-40 top-0 flex h-screen w-screen md:w-64 {{ $sidebarState ? '' : '-translate-x-[calc(100%-4.8rem)]' }} flex-col-reverse overflow-y-auto bg-base-200 p-4 text-text-primary transition-transform duration-300"
